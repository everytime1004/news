...
class ClipsControllerTest < ActionController::TestCase
  ...
  test "should create clip" do
    assert_difference('Clip.count') do
      post :create, clip: { memo: @clip.memo, newspaper_id: @clip.newspaper_id, user_id: @clip.user_id }
    end
  ...
  test "should update clip" do
    put :update, id: @clip, clip: { memo: @clip.memo, newspaper_id: @clip.newspaper_id, user_id: @clip.user_id }
    assert_redirected_to clip_path(assigns(:clip))
  end
