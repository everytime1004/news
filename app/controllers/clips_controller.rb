class ClipsController < ApplicationController
  ...
  def edit
    ...
    @clip_newspaper = @clip.newspaper_id
  end
  ...
  def create
    @user = current_user
    newspaper = Newspaper.find(params[:newspaper])
    @clip = @user.clips.new(newspaper: newspaper)
    if @clip.check_clip(params[:newspaper])
    ...
    respond_to do |format|
      if @clip.save
        format.html { redirect_to edit_clip_path(@clip), notice: 'Clip was successfully created.' }
